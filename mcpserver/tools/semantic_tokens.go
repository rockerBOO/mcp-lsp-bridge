...
func SemanticTokensTool(bridge interfaces.BridgeInterface) (mcp.Tool, server.ToolHandlerFunc) {
	return mcp.NewTool("semantic_tokens",
			mcp.WithDescription("Get semantic tokens for a specific range of a file. POWERFUL for code analysis - provides precise token classification that enables advanced syntax highlighting and symbol identification."),
